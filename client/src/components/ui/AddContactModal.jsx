...
import { useCreateContactWithNotification } from "../../hooks/useServicesWithNotification";
...
const AddContactModal = ({ isOpen, onClose }) => {
  ...
  const { mutate: addContact, isPending } = useCreateContactWithNotification({
    onSuccess: () => {
      onClose();
      setFormData({
        firstName: "",
  ...
  const footerButtons = [
    ...
    {
      label: isPending ? "Creating..." : "Create Contact",
